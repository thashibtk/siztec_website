            ...
            <div className="col-lg-6 order-lg-1">
              <ScrollAnimation>
                <div className="feature-img">
                  <img src="/images/media/img-1.webp" alt="Siztec Technical Services" />
                </div>
              </ScrollAnimation>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-xl-12 text-center">
              <ScrollAnimation>
                ...
                <Link href="/contact_us" className="cta-btn me-3">Contact Us</Link>
                <Link href="/services" className="cta-btn">View Our Services</Link>
              </ScrollAnimation>
            </div>
          </div>
        </div>
