          ...
          <div className="row align-items-center">
            <div className="col-lg-6 order-lg-2 mb-4 mb-lg-0">
              <ScrollAnimation>
                <div className="service-img">
                  <img 
                    src="../images/services/technical-outsourcing.webp" 
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 mb-4 mb-lg-0">
              <ScrollAnimation>
                <div className="service-img">
                  <img 
                    src="../images/services/project-staffing.webp" 
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 order-lg-2 mb-4 mb-lg-0">
              <ScrollAnimation>
                <div className="service-img">
                  <img 
                    src="../images/services/shutdown-work.webp" 
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 mb-4 mb-lg-0">
              <ScrollAnimation>
                <div className="service-img">
                  <img 
                    src="../images/services/permanent-recruitment.webp " 
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 order-lg-2 mb-4 mb-lg-0">
              <ScrollAnimation>
                <div className="service-img">
                  <img 
                    src="../images/services/workforce-management.webp" 
